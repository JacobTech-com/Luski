...
{
    /// <summary>
    /// Adds a themed customized TabControl.
    /// </summary>
    [ToolboxBitmap(typeof(System.Windows.Forms.TabControl))]

    public class LuskiTabControl : System.Windows.Forms.TabControl
    {
        ...
        private Color mBackColor = Color.FromArgb(255, 46, 46, 46);
        private Color mShadowColor = Color.Empty;

        public LuskiTabControl()
        {
            ControlBackColor = Luski.GUI.CurrentTheme.Theme.BackColor;
            ...
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(LuskiTabControl));
            Bitmap updownImage = new Bitmap(16, 16);
        ...
        internal void DrawControl(Graphics g)
        {
            ...
            if (this.SelectedTab != null)
            {
                ...
                tabPage.BackColor = Luski.GUI.CurrentTheme.Theme.ActiveColor;
        ...
        private void UpdateTabColor()
        {
            ...
            {
                tpCheck.BackColor = Luski.GUI.CurrentTheme.Theme.InactiveColor;
                tpCheck.ForeColor = Luski.GUI.CurrentTheme.Theme.DisabledColor;
            }

            if (SelectedTab != null)
            {
                SelectedTab.BackColor = Luski.GUI.CurrentTheme.Theme.ActiveColor;
                SelectedTab.ForeColor = Luski.GUI.CurrentTheme.Theme.ForeColor;
            }
        ...
        internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
        {
            ...
            tabPage.BackColor = Luski.GUI.CurrentTheme.Theme.InactiveColor;
            tabPage.ForeColor = Color.FromArgb(255, 84, 84, 84);
            if (this.SelectedTab != null)
            {
                this.SelectedTab.BackColor = Luski.GUI.CurrentTheme.Theme.ActiveColor;
                this.SelectedTab.ForeColor = Luski.GUI.CurrentTheme.Theme.ForeColor;
            }
            //----------------------------
            ...
            g.DrawPolygon(new Pen(Color.FromArgb(24, 24, 24)), pt);
        ...
        [Browsable(true)]
        new public Color ControlBackColor
        {
